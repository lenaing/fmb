...
{$fmbBlogLinks}
                    ...
                    <li>
                        <h2>Validations</h2>
                        <ul>
                            <li><a href="http://validator.w3.org/check?uri=referer"><img src="{$fmbTemplatesUrl}{$fmbStyle}/blog/images/xhtml.png" alt="Valide XHTML 1.0 Strict." height="31" width="88"/></a></li>
                            <li><a href="http://jigsaw.w3.org/css-validator/check/referer"><img src="{$fmbTemplatesUrl}{$fmbStyle}/blog/images/css.png" alt="Valide CSS." height="31" width="88"/></a></li>
                        </ul>
                    </li>
                    <li>
                        <h2>Licence</h2>
